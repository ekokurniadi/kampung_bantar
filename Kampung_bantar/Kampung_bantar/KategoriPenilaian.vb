...
msg:    MsgBox("Opps, Something went wrong !!")
    ...
    Private Sub KategoriPenilaian_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call koneksinya()
        placeholder()
        autonumber()
        view()
    ...
    Sub autonumber()
        ...
        If Not rd.HasRows Then
            txt_kode.Text = "1"
        Else
            txt_kode.Text = Val(Microsoft.VisualBasic.Mid(rd.Item("kode_alternatif").ToString, 1, 1)) + 1
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Else
            Dim sqledit As String = "update alternatif set nama_kampung = '" & txt_nama.Text & _
                   "',kode_kampung = '" & "" & "' where kode_alternatif='" & txt_kode.Text & "'"
